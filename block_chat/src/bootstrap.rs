...
pub fn bootstrap_network(
    total_peers: u16,
    cents_per_peer: u32, // why cents? check the CENTS_PER_COIN constant in protocol.rs
    bootstrap_peer_addr: impl ToSocketAddrs,
    bootstrap_port: u16, // why two different ports? check ProtocolConfig in protocol.rs
    network_port: u16,
    publ_key: PublicKey,
...
fn discover_peers(
    ...
    loop {
        ...
        // to signify that it's the bootstrap peer
